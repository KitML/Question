...
<head>
    ...
    <style>
        ...
        .login-main .login-bottom .center .item .validateImg {position:absolute;right:1px;cursor:pointer;height:50px;border:1px solid #e6e6e6;}
...
<%--                <span class="login-tip">保持登录</span>--%>
                <a href="/api/sysUser/regeister " class="forget-password">注册账号</a>
            </div>
            <div class="layui-form-item" style="text-align:center; width:100%;height:100%;margin:0px;">
                <button class="login-btn" id="loginBtn" type="button">立即登录</button>
            </div>
        </form>
    </div>
</div>
<div class="footer">
    ©版权所有 2022-2023 暮城工作室<span class="padding-5">|</span><a target="_blank" href="http://www.miitbeian.gov.cn">赣ICP备20000112号-2</a>
</div>
